...
try:
    ...
    # driver.find_element(By.CSS_SELECTOR, "div.ui-tag-selector-tag-remove").click() # кликает на 1-й элемент, в данном случае - Поладько
    ...
    print("actual_text - ", actual_text2)
    needed_text = "С сообщением ознакомлен"
    assert needed_text == actual_text2
    print("важное сообщение ")
